...
@section('content')
    ...
    <div class="container">
        <form action="{{ route('comics.store')}}" method="POST">
            ...
            <input class="form-control" type="text" placeholder="Price" aria-label=".form-control-sm example" name="thumb">
            <input class="form-control" type="text" placeholder="Img (URL)" aria-label=".form-control-sm example" name="price">
